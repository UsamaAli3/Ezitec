...
function LearnAnyThing() {
  return (
    <>
      <div className="flex w-full h-svh  justify-center items-center overflow-hidden flex-col sm:flex-row">
        <div className=" w-1/2 ">
          <div className="bg-blue-600 w-96 h-96 m-auto p-auto rounded-full flex justify-center items-center mt-10">
            <img
              className=" w-[405px] h-[629px] mr-16"
        ...
        <div className="w-1/2  ">
          <div class="w-[30rem] h-svh p-4bg-white sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-60 ">
            ...
            <p class="mb-5 text-base  text-gray-500 sm:text-base dark:text-gray-400">
              ...
              productive using modren LMS app.
            </p>
            <div class=" items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
              <a
                href="#"
